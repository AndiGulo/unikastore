...
?>
 ...
 $semuadata=array();
 $ambil=$conn->query("SELECT * FROM produk WHERE namaproduk LIKE '%furnitur%' OR  namaproduk  LIKE '%meja%'
                       OR  namaproduk  LIKE '%lemari%'   OR  namaproduk  LIKE '%kursi%'  OR  namaproduk  LIKE '%sofa%' ");
